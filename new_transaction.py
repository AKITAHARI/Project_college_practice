# -*- coding: utf-8 -*-
# [Александр Денисов] - Tech Lead [Александр Денисов] - Backend
################################################################################
...
"    spread:pad,\n"
"    x1:1, y1:1, x2:0, y2:0,\n"
"    stop:0 rgba(143, 188, 143, 255),  /* Avocado Green */\n"
"    stop:0.5 rgba(133, 175, 95, 235),  /* Dark Olive Green */\n"
"    stop:1 rgba(244, 232, 129, 255)   /* Light Avocado */\n"
");\n"
"")
...
"padding-left: 10px;")
        ...
        self.dateEdit.setDateTime(QDateTime(QDate(2025, 4, 30), QTime(17, 0, 0)))
